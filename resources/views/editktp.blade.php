    ...
    <main role="main" class="container">
      ...
      <div class="row">
        <div class="col-12 .col-md-8">
            <form action="/editktp/update" method="post" enctype="multipart/form-data">
                {{ csrf_field() }}
                @error('ktp')
                ...
                <ul class="list-group">
                    <div class="text-center">
                        <img src="{{ url('/data_file/'. $driver->ktp) }}" style="width: 500px; height: 500px;" class="rounded mx-auto d-block">
                    </div>
                    <br>
