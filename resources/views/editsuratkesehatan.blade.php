    ...
    <main role="main" class="container">
      ...
      <div class="row">
        <div class="col-12 .col-md-8">
            <form action="/editsuratkesehatan/update" method="post" enctype="multipart/form-data">
                {{ csrf_field() }}
                <input type="hidden" name="id" value="{{ $driver->id }}"> <br/>
                <ul class="list-group">
                    <div class="text-center">
                        <img src="{{ url('/data_file/'. $driver->suratkesehatan) }}" style="width: 500px; height: 500px;" class="rounded mx-auto d-block">
                    </div>
                    <br>
                    <div class="input-group">
                        <div class="custom-file col-12 col-md-12">
                            <input type="file" class="custom-file-input" id="suratkesehatan" name="suratkesehatan" required>
